...
public class ServiceFactory {
    public static RoomDomainService createRoomService(IRoomRepository roomRepository, IItemRepository itemRepository) {
    ...
    public static BookingApplicationService createBookingService(
        ...
        return new BookingApplicationService(new RoomDomainService(roomRepository, itemRepository), new UserDomainService(userRepository));
    }
}
